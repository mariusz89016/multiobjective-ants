...
public class AntsColony2 {
    ...
    public AntsColony2(double alpha, double beta, double rho, double q0, double tau0, int numAnts, double weight1, double weight2) {
        this.alpha = alpha;
        this.beta = beta;
        this.rho = rho;
        this.q0 = q0;
...
//                pheromones[i][j] = tau0;
    ...
    public void updateAnts(int[][] ants, double[][] pheromones, double[][] distances, double[][] distances2) {
    ...
    private int[] buildRoute(int i, int start, double[][] pheromones, double[][] distances, double[][] distances2) {
        int numCities = pheromones.length;
    ...
    private int nextCity(int i, int cityX, boolean[] visited, double[][] pheromones, double[][] distances, double[][] distances2) {
    ...
    private double[] moveProbabilities(int i, int cityX, boolean[] visited, double[][] pheromones, double[][] distances, double[][] distances2) {
        int numCities = pheromones.length;
